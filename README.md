...
**Контрольная группа: stat = ПРИВЕСТИ СТАТИСТИКУ, p_value =**

**Тестовая группа: stat = ПРИВЕСТИ СТАТИСТИКУ, p_value =**
...
**Тест Левена показал следующие результаты: stat=7.374, pvalue=0.006**
...
**Тест Уэлча показал следующие результаты: stat=-38.368, pvalue=7.166e-198**
